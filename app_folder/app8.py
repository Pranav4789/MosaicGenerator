...
str_url = "http://sp23-cs340-080.cs.illinois.edu:9008/makeMosiac"
def_url = "http://sp23-cs340-adm.cs.illinois.edu:1989/"

return_json = dict()
return_json["name"] = "travellandmarks"
return_json["url"] = str(str_url)
return_json["author"] = "Pranav Penaganti"
return_json["tileImageCount"] = 66
...
def main():
    ...
    try:
        for img in os.listdir("tile_folder/travellandmarks"):
            img_location.append(img)

        for i in img_location:
            p = os.path.join("tile_folder/travellandmarks", i)
        ...
        out_str = "tile_folder/travellandmarks"
