...
str_url = "http://sp23-cs340-080.cs.illinois.edu:9001/makeMosiac"
def_url = "http://sp23-cs340-adm.cs.illinois.edu:1989/"

return_json = dict()
return_json["name"] = "albumcovers"
...
def main():
    ...
    try:
        for img in os.listdir("tile_folder/albumcovers"):
            img_location.append(img)

        for i in img_location:
            p = os.path.join("tile_folder/albumcovers", i)
        ...
        out_str = "tile_folder/albumcovers"
