...
str_url = "http://sp23-cs340-080.cs.illinois.edu:9006/makeMosiac"
def_url = "http://sp23-cs340-adm.cs.illinois.edu:1989/"

return_json = dict()
return_json["name"] = "sportsmoments"
return_json["url"] = str(str_url)
return_json["author"] = "Pranav Penaganti"
return_json["tileImageCount"] = 61
...
def main():
    ...
    try:
        for img in os.listdir("tile_folder/sportsmoments"):
            img_location.append(img)

        for i in img_location:
            p = os.path.join("tile_folder/sportsmoments", i)
        ...
        out_str = "tile_folder/sportsmoments"
