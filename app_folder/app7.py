...
str_url = "http://sp23-cs340-080.cs.illinois.edu:9007/makeMosiac"
def_url = "http://sp23-cs340-adm.cs.illinois.edu:1989/"

return_json = dict()
return_json["name"] = "sunsets:sunrises"
return_json["url"] = str(str_url)
return_json["author"] = "Pranav Penaganti"
return_json["tileImageCount"] = 64
...
def main():
    ...
    try:
        for img in os.listdir("tile_folder/sunsets:sunrises"):
            img_location.append(img)

        for i in img_location:
            p = os.path.join("tile_folder/sunsets:sunrises", i)
        ...
        out_str = "tile_folder/sunsets:sunrises"
