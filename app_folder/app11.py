...
str_url = "http://sp23-cs340-080.cs.illinois.edu:9011/makeMosiac"
def_url = "http://sp23-cs340-adm.cs.illinois.edu:1989/"

return_json = dict()
return_json["name"] = "dogs"
...
def main():
    ...
    try:
        for img in os.listdir("tile_folder/dogs"):
            img_location.append(img)

        for i in img_location:
            p = os.path.join("tile_folder/dogs", i)
